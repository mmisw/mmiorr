...
abstract class RegisterExternalOntologyPageBase  {
	...
	protected final RegisterExternalOntologyWizard wizard;
	...
	protected final PushButton backButton = new PushButton("< Back", new ClickListener() {
		public void onClick(Widget sender) {
			wizard.pageBack(RegisterExternalOntologyPageBase.this);
		}
	});
	
	protected final PushButton nextButton = new PushButton("Next >", new ClickListener() {
		public void onClick(Widget sender) {
			wizard.pageNext(RegisterExternalOntologyPageBase.this);
		}
	});
	
	protected final PushButton finishButton = new PushButton("Finish", new ClickListener() {
		public void onClick(Widget sender) {
			wizard.finish(RegisterExternalOntologyPageBase.this);
		}
	});
