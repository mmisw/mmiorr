...
public class AuthorityShortNamePanel extends VerticalPanel {
	...
	AuthorityShortNamePanel(RegisterExternalOntologyPageFullyHosted page) {
		this.page = page;
		authorityAttrDef = Main.metadataBaseInfo.getAuthorityAttrDef();
	...
	private Widget createForm() {
		...
		String label3 = "URI";
		String tooltip3 = "<b>" +label2+ "</b>:<br/>" + 
				"<br/><br/>The resulting URI for your ontology";
	...
	void initFields() {
		if ( shortNameTextBox.getText().trim().length() == 0
		&&   page.wizard.tempOntologyInfo != null
		&&   page.wizard.tempOntologyInfo.getShortName() != null
		) {
			shortNameTextBox.setText(page.wizard.tempOntologyInfo.getShortName());
			formChanged();
		}
	}
