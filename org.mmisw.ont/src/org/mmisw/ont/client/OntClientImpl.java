...
class OntClientImpl implements IOntClient {
	...
	/**
	 * Returns the library interface object created by {@link #init(OntClientConfiguration)}.
	...
	public String resolveOntologyUri(String uriModel, String version,
			String... acceptEntries) throws Exception {
		return OntClientUtil.resolveOntologyUri(uriModel, version, acceptEntries);
	}
	...
	public String runSparqlQuery(String endPoint, String query, String format,
			String... acceptEntries) throws Exception {
		return OntClientUtil.runSparqlQuery(endPoint, query, format, acceptEntries);
	}
